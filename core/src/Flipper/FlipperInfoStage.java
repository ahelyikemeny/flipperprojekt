...
public class FlipperInfoStage extends MyStage {
    ...
    public FlipperInfoStage(MyGame game) {
        ...
        MyLabel label = new MyLabel(game, "A kepernyo bal es jobb szelet erintve tudjuk az utoket hasznalni. ", labelStyle);
        label.setFontScale(0.1f);
        label.setPosition(0,70);
        addActor(label);


        MyLabel label2 = new MyLabel(game, " A cel hogy eltalald a palya tetejen levo erzekeloket. ", labelStyle);
